...
class RoughsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rough" do
    assert_difference("Rough.count") do
      post roughs_url, params: { rough: { content: @rough.content, house_id: @rough.house_id, picture: @rough.picture } }
    end
  ...
  test "should update rough" do
    patch rough_url(@rough), params: { rough: { content: @rough.content, house_id: @rough.house_id, picture: @rough.picture } }
